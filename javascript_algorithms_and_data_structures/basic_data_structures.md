...
```
let yourArray = ['Jack', 'Jill', 5, 6, true]; // Change this line
```
...
let myNestedArray = [
  ...
  ['concat', false, true, 'spread', 'array', ['I', 'am', 'deep']],
  ['mutate', 1327.98, 'splice', 'slice', 'push', [['I', 'am', 'deeper']]],
  ['iterate', 1.3849, '8.4876', 'arbitrary', 'depth', [[['and', 'I', 'am', 'the', 'deepest']]]]
  // Only change code above this line
];
```
